package day09_handleWidndows_testBase;
...
public class C02_HandleWindows {
    ...
    public void test01() throws InterruptedException {
        ...
        Assert.assertTrue(actionUrl.contains(istenenKelime));
        ...
        String avctualTitle = driver.getTitle();
        String arananKelime = "Best Buy";
        Assert.assertTrue(avctualTitle.contains(arananKelime));
