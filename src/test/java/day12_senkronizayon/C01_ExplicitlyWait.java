...
public class C01_ExplicitlyWait extends TestBase {
    ...
    @Test
    public void C01_ExplicitlyWaitTesti (){
    ...
    public void explicitlywaitTesti() {
        ...
        yazının gorunun olmasını beklerken yazının locate ini kullanmak sorun olusturu.
        cunku henüz gorunmeyen bir yazının locate edilmesi de münkün olmayabilir.
        (html kodları yazıan devoloper farklı uygulamalar yapabilr bu durumda bekleme işlemi ve locate i
        birlikte yapmalıyız.)
         */
